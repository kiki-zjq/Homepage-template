<template>
    <div class='document-block'>
        ...
        <div style="margin-left:2em;" v-if='language=="English"'>
                <p>Jiangqi Zhu, a junior student from Beijing University of Posts and Telecommunications (BUPT).My college major is telecommunications engineering with Management with overall GPA 91.9/100 , <b>ranking 1st among 328</b>. </p>
        ...
        <div class='sub-title' id='skill'>
            ...
            <RectTreeChartEN  v-if='language=="English"' class='rect-tree-chart'/>
        <el-divider></el-divider>
